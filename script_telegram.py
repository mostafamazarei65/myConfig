...
api_token="1952283627:AAFiGanCt6Kba_O8mCzPpqnxrYqEUbaECR8"
id="-442886636"
log="/var/log/bacula/telegram.log"
proxy="http://proxy.fwut.local:3128"
...
message="${header}/nBackupServer=${HOSTNAME}/nJobName=${JobName}/nJobid=${JobId}/nClient=${Client}/nJobBytes=${JobBytes}/nJobFiles=${JobFiles}/nLevel=${Level}/nPool=${Pool}/nStorage=${Storage}/nStartTime=${StartTime}/nEndTime=${EndTime}/nDuration=${Duration}/nJobStatus=${JobStatus}/nStatus=${Status}"
